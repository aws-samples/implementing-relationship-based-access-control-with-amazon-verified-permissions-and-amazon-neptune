 ...
 */
type StillToProvideVerifyKeys<Base, Provided> = keyof Omit<Base, keyof Provided>;
/**
 ...
 */
export type Properties<Base, Provided> = StillToProvideProperties<Base, Provided> & Partial<Base>;
export type AsAsync<T extends (...args: any[]) => unknown> = (...args: Parameters<T>) => Promise<ReturnType<T>>;
export {};
